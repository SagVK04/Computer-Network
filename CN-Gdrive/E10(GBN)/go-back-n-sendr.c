...
void handle(int sig){
	...
	switch(sig){
		case SIGIO:
			...
			break;
		case SIGALRM:
			printf("SIGALRM ::Timeout ....going back to slast = %d\n", slast);
			srecent = slast;
			break;
		case SIGINT:
			close(sock);
			printf("\n\t.....................Thanks to use thid software.................\n");
			printf("\n\t.....................Exiting...............\n");
			exit(0);
			break;
	}
