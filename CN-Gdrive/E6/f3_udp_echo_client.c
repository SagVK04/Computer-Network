...
int main(int argc, char *argv[]){
	...
	write(STDOUT_FILENO, "u-c-c: Enter the String:",24);
	...
	printf("u-c-c:Sent %u bytes to server \n", n);
	
	memset(buffer, '\0', SIZE);
	
	#ifdef RECVFROM_FULL
	printf("u-c-c: Using recvfrom() call in Full form\n");
	...
	printf("u-c-c: Using recvfrom() call in stripped form\n");
	...
	#ifdef READ
	printf("u-c-c: Using read() call in\n");
	...
	printf("u-c-c: Received %u bytes from server \n", n);
	write(STDOUT_FILENO, "u-c-c: From server \n", n);
